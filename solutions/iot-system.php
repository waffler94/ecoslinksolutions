    ...
    <main class="">
        <section class="">
          ...
          <div class='w-11/12 sm:w-5/6 mx-auto mb-6 md:mb-12'>
            <div class='flex flex-col lg:flex-row justify-between items-start gap-12 mt-6 md:mt-12' data-aos="fade-up">
              <div class="w-2/3">
          ...
          <div class='w-11/12 sm:w-5/6 mx-auto mb-6 md:mb-12'>
            <div class="grid gap-6 grid-cols-1 md:grid-cols-3">
              ...
              <div class="system_box leading-[1.2]" data-aos="fade-down">
                ...
                <p class="text-[14px] md:text-[16px] text-[#8987A1] leading-[1.2]">Utilizes advanced analytics and machine learning to forecast production trends, optimize processes, and monitor key performance indicators (KPIs).</p>
              </div>
            </div>
            <div class="grid gap-6 grid-cols-1 md:grid-cols-2 mb-8 mt-6">
              ...
              <div class="system_box leading-[1.2]" data-aos="fade-up">
                ...
                <p class="text-[14px] md:text-[16px] text-[#8987A1] leading-[1.2]">Allows management to monitor plant operations remotely and receive alerts on critical issues, ensuring quick response to anomalies.</p>
              </div>
            </div>
          </div>
