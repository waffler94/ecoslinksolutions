                  ...
                  <div class="dropdown pt-6">
                      <ul class="submenu">
                        <li class="menu-item with-subdropdown block w-full">
                          ...
                          <li class="menu-item with-subdropdown block w-full">
                              <a href="/solutions/iot-system" class=" block w-full px-6 py-3">ECOS-IOT-26</a>
                          </li>
                          <li class="menu-item with-subdropdown block w-full">
        ...
        <div class="relative min-[1024px]:hidden block w-full">
          <div class="flex justify-between items-center w-full px-6 max-[767px]:py-4 mobile_menu">
            <img 
                  ...
                  height="100"
              />
            <div class="burger-icon z-[60] cursor-pointer" id="burger-icon">
              <div class="bar"></div>
              <div class="bar"></div>
              <div class="bar"></div>
            </div>
            <div class="menu" id="menu">
              <img 
                  ...
                  alt="Logo"
                  class="block mt-6 ml-2"
                  width="200"
                  height="100"
              />
              <ul class="mt-6 min-[575px]:mt-12">
                <li><a href="/">Home</a></li>
              ...
              <p class="bottom-0 left-0 right-0 text-black mx-auto px-4 text-center text-[11px] py-6">&copy; <span class="latestYear"></span> ECOSLINKSOLUTIONS. All rights reserved.</p>
            </div>
